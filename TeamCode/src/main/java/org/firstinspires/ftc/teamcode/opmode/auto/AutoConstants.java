...
public final class AutoConstants {
    ...
    public static Pose2d CENTER_BACKDROP_PRE = new

            Pose2d(V_CENTER_BACKDROP_PRE.x, V_CENTER_BACKDROP_PRE.y, V_CENTER_BACKDROP_PRE.heading);

    public static Pose2d RIGHT_BACKDROP_PRE = new

            Pose2d(V_RIGHT_BACKDROP_PRE.x, V_RIGHT_BACKDROP_PRE.y, V_RIGHT_BACKDROP_PRE.heading);

    public static Pose2d LEFT_BACKDROP = new

            Pose2d(V_LEFT_BACKDROP.x, V_LEFT_BACKDROP.y, V_LEFT_BACKDROP.heading);

    public static Pose2d CENTER_BACKDROP = new

            Pose2d(V_CENTER_BACKDROP.x, V_CENTER_BACKDROP.y, V_CENTER_BACKDROP.heading);

    public static Pose2d RIGHT_BACKDROP = new

            Pose2d(V_RIGHT_BACKDROP.x, V_RIGHT_BACKDROP.y, V_RIGHT_BACKDROP.heading);

    // MISC POSITIONS
    public static Pose2d NEAR_INITIAL = new

            Pose2d(V_NEAR_INITIAL.x, V_NEAR_INITIAL.y, V_NEAR_INITIAL.heading);

    public static Pose2d FAR_INITIAL = new

            Pose2d(V_FAR_INITIAL.x, V_FAR_INITIAL.y, V_FAR_INITIAL.heading);

    public static Pose2d NEAR_MID = new

            Pose2d(V_NEAR_MID.x, V_NEAR_MID.y, V_NEAR_MID.heading);
